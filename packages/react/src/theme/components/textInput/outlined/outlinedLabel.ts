const outlinedLabelClasses = {
  fontSize: 'text-base peer-placeholder-shown:text-base peer-valid:text-base',
  floated: {
  ...
  top: 'top-2',
  left: 'left-2.5',
  scale: 'peer-focus:scale-75 peer-placeholder-shown:scale-100 peer-valid:scale-75',
  zIndex: 'z-10',
  origin: 'origin-[0]',
