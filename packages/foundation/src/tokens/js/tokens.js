  ...
  colors: {
    ...
    neutral: {
      ...
      75: {
        ...
        name: 'ColorsNeutral75',
        attributes: {
          category: 'colors',
          type: 'neutral',
          item: '75',
        },
        path: ['colors', 'neutral', '75'],
      },
      100: {
        value: '#F4F6FA',
        filePath: 'src/tokens/colors.json',
